...
def createMIP(np_img, slices_num=10):  # TODO:可修改此处调整投影的切片数
...
if __name__ == '__main__':
    img_path = r'K:\paper\8-vessel_map\HC\dalian\img'
    save_path = r'K:\paper\8-vessel_map\3d_mip\10\HC\dalian'
